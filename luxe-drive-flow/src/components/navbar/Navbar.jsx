        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 bg-[#c9a96e] text-black text-sm px-5 py-2 rounded-full font-medium hover:bg-[#c9a96e] hover:text-black transition-all duration-300"
            >
              Find Us
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-white text-black text-sm px-5 py-2 rounded-full font-medium hover:bg-white hover:text-black transition-all duration-300"
            >
              Contact Us
        ...
        {mobileOpen && (
          ...
          >
            ...
            <button
              ...
              className="inline-flex items-center gap-2 bg-[#c9a96e] text-black text-lg px-8 py-3 rounded-full font-medium mt-2"
            >
              Find Us
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-white text-black text-lg px-8 py-3 rounded-full font-medium mt-2 cursor-pointer"
            >
              Contact Us
